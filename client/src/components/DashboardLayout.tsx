...
import { Activity, BellRing, ClipboardList, FileText, LayoutDashboard, LogOut, PanelLeft, PlusCircle, Radar, ScrollText, ShieldCheck, Upload, UsersRound } from "lucide-react";
